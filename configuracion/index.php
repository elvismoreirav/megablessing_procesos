...
$counts = [
    ...
    'cajones' => $db->fetchOne("SELECT COUNT(*) as c FROM cajones WHERE activo = 1")['c'],
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <!-- Encabezado -->
    <div class="mb-8">
        <h1 class="text-3xl font-bold text-shalom-dark">Configuración del Sistema</h1>
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <!-- Proveedores -->
            <a href="proveedores.php" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow group">
            ...
            <!-- Variedades -->
            <a href="variedades.php" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow group">
                <div class="flex items-center justify-between mb-4">
            ...
            <a href="cajones.php" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow group">
                <div class="flex items-center justify-between mb-4">
            ...
            <!-- Secadoras -->
            <a href="secadoras.php" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow group">
                <div class="flex items-center justify-between mb-4">
            ...
            <!-- Estados -->
            <a href="estados.php" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow group">
                <div class="flex items-center justify-between mb-4">
            ...
            <!-- Parámetros -->
            <a href="parametros.php" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow group">
                <div class="flex items-center justify-between mb-4">
    ...
    <div class="mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <!-- Usuarios -->
            <a href="/usuarios/index.php" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow group">
                <div class="flex items-center justify-between mb-4">
            ...
            <!-- Roles -->
            <a href="roles.php" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow group">
                <div class="flex items-center justify-between mb-4">
            ...
            <!-- Backup -->
            <a href="backup.php" class="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow group">
                <div class="flex items-center justify-between mb-4">
    ...
    <!-- Acciones Rápidas -->
    <div class="bg-shalom-olive/20 rounded-xl p-6">
        <h3 class="text-lg font-semibold text-shalom-dark mb-4">Información del Sistema</h3>
